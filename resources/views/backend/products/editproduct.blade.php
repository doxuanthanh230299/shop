                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="featured" class="form-control">
                                            <option {{ $product['featured'] == 1 ? '' : 'selected' }} value="0">Không
                                            </option>
                                            <option {{ $product['featured'] == 1 ? 'selected' : '' }} value="1">Có
                                            </option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="state" class="form-control">
                                            <option {{ $product['state'] == 1 ? 'selected' : '' }} value="1">Còn hàng
                                            </option>
                                            <option {{ $product['state'] == 1 ? '' : 'selected' }} value="0">Hết hàng
                                            </option>
                                        </select>
                                    </div>
                                </div>
